...
main:
  ...
  ldr r0, =0x40023800
  add r0, r0, #0x30
  ldr r1, [r0] // AHB1 Peripheral Enable Register
  orr r2, r1, #1 // GPIOA Clock Enable
  str r2, [r0]

  // Confiure GPIO registers
  ldr r0, =0x40020000 // GPIOA Base
  ldr r1, [r0] // GPIOA_MODER
  orr r2, r1, #4
  ldr r3, =0xFFFFFFF7 // ~(1 << 3) bitmask
  and r4, r2, r3
  str r4, [r0]

  add r0, r0, #0x14 // GPIOA_ODR
  ldr r1, [r0]
  orr r1, r1, #2 // GPIOA Pin 1 Output
  str r1, [r0]
